...
This JavaScript program prompts the user to input student marks between 0 and 100 and calculates the corresponding grade based on the specified grade ranges.        
